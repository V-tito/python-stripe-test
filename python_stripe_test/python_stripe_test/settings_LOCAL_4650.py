"""
Django settings for python_stripe_test project.
...
storeapp=os.path.join(BASE_DIR,'store')
INSTALLED_APPS = [
...
ROOT_URLCONF = 'python_stripe_test.urls'
...
WSGI_APPLICATION = 'python_stripe_test.wsgi.application'
